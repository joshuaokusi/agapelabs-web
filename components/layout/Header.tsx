    ...
    <header className="py-4 border-b border-gray-100">
      <div className="container flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          ...
          <Link href="/services" className="text-black hover:text-gray-600 font-medium transition">
            Services
          </Link>
      ...
      {menuOpen && (
        <div className="md:hidden absolute top-20 left-0 right-0 bg-white z-50 shadow-lg animate-fade">
          <div className="container py-4 flex flex-col space-y-4">
            ...
            <Link href="/services" className="text-black hover:text-gray-600 font-medium py-2 transition" onClick={toggleMenu}>
              Services
            </Link>
